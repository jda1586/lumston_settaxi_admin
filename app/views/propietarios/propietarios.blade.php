    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Crear un Propietario</h4>
            </div>
            <div class="modal-body">
                <form novalidate="" class="form-horizontal form-bordered" data-parsley-validate="true" name="new-form" method="post" action="propietarios/nuevo">
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">Nombre :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" id="nombre" name="nombre" placeholder="Nombre del Propietario"
...
<div id="content" class="content">
    <div class="row">
        <div class="col-md-12">
            <a href="#modalCreate" class="btn btn-sm btn-inverse pull-left" data-toggle="modal"><i class="fa fa-plus m-r-5"></i> Nuevo Propietario</a>
        ...
        <div class="col-md-12 ui-sortable">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Lista de Propietarios
                </div>
                            ...
                            <div class="col-sm-12">
                                <table aria-describedby="data-table_info" role="grid" id="data-table" class="table table-striped table-bordered dataTable no-footer dtr-inline">
                                    ...
                                    <tbody>
                                        ...
                                        {
                                            $label = ($prop->status == "activo") ? "success" : "default";
                                            $link = "/propietarios/" . $prop->id . "/" . $prop->nombre . " " . $prop->apellidos;
                                            $linkDel = "/propietarios/delete/" . $prop->id;
                                            ?>
                                            <tr role="row" class="gradeX odd">
                                                <td><?= $prop->id ?></td>
                                                <td><a href="<?= $link ?>"><?= $prop->nombre ?> <?= $prop->apellidos ?></a></td>
                                                <td><?= $prop->telefono ?></td>
                                                <td class="sorting_1"><?= $prop->created_at ?></td>
                                                <td><span class="label label-<?= $label ?>"><?= $prop->status ?></span></td>
                                                <td class="sorting_1">
...
<script src="assets/js/apps.min.js"></script>
<script src="assets/js/admin/propietarios.js"></script>
<!-- ================== END PAGE LEVEL JS ================== -->
